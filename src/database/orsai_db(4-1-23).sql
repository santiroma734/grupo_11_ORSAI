...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `id_user_category` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `image`, `phone`, `id_user_category`) VALUES
	('1', 'Johan', 'Rawet', 'jrawet0@github.com', 'N4UPvbc', 'usuario1', '2034348475', 0),
	('10', 'Kermie', 'Whyteman', 'kwhyteman9@vkontakte.ru', 'OOFN8cq', 'usuario10', '4378486336', 0),
	('11', 'Ag', 'Normandale', 'anormandalea@boston.com', 'x63pxh7', 'usuario11', '2716324911', 0),
	('12', 'Carmela', 'Martinie', 'cmartinieb@ucla.edu', 'QtIwo2h7d', 'usuario12', '3568645351', 0),
	('13', 'Teodora', 'Hovee', 'thoveec@omniture.com', 'mpsi7ZoB8HVu', 'usuario13', '2355711457', 0),
	('14', 'Fedora', 'Bitterton', 'fbittertond@foxnews.com', 'TRoqn1tgp', 'usuario14', '9767161737', 0),
	('15', 'Darda', 'Sayer', 'dsayere@wsj.com', 'Q7V1rri70', 'usuario15', '6899299374', 0),
	('16', 'Winn', 'Teager', 'wteagerf@bluehost.com', 'spO6u3GV3', 'usuario16', '1839576258', 0),
	('1669768692701', 'Maximo', 'Cozzetti', 'maxcozetti@gmail.com', '$2a$07$y4K0iGxZv/MNjplZvGS8..e9zD2zLqB5r5SAMCbgHGRFu0BUe7DDa', 'Luis_Alberto_Spinetta_en_1976.jpg', '1145493558', 0),
	('1669773319029', 'Santi', 'Leklere', 'santileklere@gmail.com', '$2a$07$NySE2TLl/McO5drkyMTFCuJ/mKTgQwnKtvalxgL2FPCb8LgZR.2RS', 'USUARIO-1669773318872.jpg', '111111111', 0),
	('17', 'Dicky', 'Rzehor', 'drzehorg@quantcast.com', 'O4azRlbBf', 'usuario17', '8193886982', 0),
	('18', 'Rosie', 'Braganza', 'rbraganzah@hao123.com', 'YwIOVeyMdL', 'usuario18', '9982958680', 0),
	('19', 'Mei', 'Ivanishchev', 'mivanishchevi@addthis.com', 'NmRhgBpt', 'usuario19', '9888283425', 0),
	('2', 'Susy', 'McKenney', 'smckenney1@weibo.com', 'YYQZD31', 'usuario2', '3765407546', 0),
	('20', 'Rianon', 'Hixley', 'rhixleyj@ftc.gov', 'N7c6ZrHe', 'usuario20', '756900949', 0),
	('21', 'Cirilo', 'Reynoollds', 'creynoolldsk@plala.or.jp', 'oMizSBZUjh1', 'usuario21', '8521838532', 0),
	('22', 'Filberto', 'Oppie', 'foppiel@google.pl', '4KMtDMEvX', 'usuario22', '5923297625', 0),
	('23', 'Briggs', 'Nuton', 'bnutonm@ucsd.edu', 'JS8NBl', 'usuario23', '7747660640', 0),
	('24', 'Lonnie', 'Pauls', 'lpaulsn@comsenz.com', 'OHsPzkVQK', 'usuario24', '7914831752', 0),
	('25', 'Claiborne', 'Wildsmith', 'cwildsmitho@sakura.ne.jp', 'Gjpswn8', 'usuario25', '3323407254', 0),
	('26', 'Amalita', 'Clayhill', 'aclayhillp@washington.edu', 'a2ydiID7v2', 'usuario26', '6739246918', 0),
	('27', 'Dael', 'Cuffley', 'dcuffleyq@issuu.com', 'iHDOcNUSQ', 'usuario27', '6187101559', 0),
	('28', 'Pate', 'Wareing', 'pwareingr@arizona.edu', 'N4NSZL9yMp', 'usuario28', '1006696947', 0),
	('29', 'Clarissa', 'Richford', 'crichfords@google.cn', 'cx4Yw1DDmq', 'usuario29', '9512893758', 0),
	('3', 'Ella', 'Paylor', 'epaylor2@nydailynews.com', '0XniG2Zk9', 'usuario3', '8045759175', 0),
	('30', 'Janine', 'Albion', 'jalbiont@hugedomains.com', 'ad6mbv', 'usuario30', '1081978879', 0),
	('4', 'Ingelbert', 'Najera', 'inajera3@baidu.com', 'W7457XnGvHMm', 'usuario4', '2636482173', 0),
	('5', 'Lorrie', 'Fidilis', 'lfidilis4@businessinsider.com', 'wGaDDqIG4', 'usuario5', '9376639806', 0),
	('6', 'Heall', 'Charnley', 'hcharnley5@marketwatch.com', 'sZF1Oa5J3', 'usuario6', '3584638045', 0),
	('7', 'Arline', 'Ateridge', 'aateridge6@redcross.org', '1n3OoK', 'usuario7', '5773717016', 0),
	('8', 'Tiffany', 'Cankett', 'tcankett7@sciencedaily.com', '40uf1U', 'usuario8', '6041367869', 0),
	('9', 'Katha', 'Climson', 'kclimson8@aol.com', 'b1JTut', 'usuario9', '9115754002', 0);
